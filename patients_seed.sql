...
CREATE INDEX IF NOT EXISTS idx_patient_measurements_organisation_id ON patient_measurements(organisation_id);
...
CREATE INDEX IF NOT EXISTS idx_patient_medical_organisation_id ON patient_medical(organisation_id);
...
CREATE INDEX IF NOT EXISTS idx_patient_medical_history_organisation_id ON patient_medical_history(organisation_id);
...
CREATE TABLE IF NOT EXISTS patient_appointment (
    ...
    appointment_type VARCHAR(100) CHECK (appointment_type IN ('Consultation', 'Medical Check', 'Clinical Procedure', 'Other')),
...
(1, 1, 2, '2024-05-15 10:00:00', 'Medical Check', 'completed', 'Follow-up visit.', NOW(), NOW()),
(1, 1, 3, '2024-05-29 11:00:00', 'Medical Check', 'cancelled', 'Patient cancelled.', NOW(), NOW()),
(1, 1, 4, '2024-06-20 09:00:00', 'Clinical Procedure', 'scheduled', 'Skin check.', NOW(), NOW()),
(1, 1, 1, '2024-07-05 10:00:00', 'Consultation', 'scheduled', 'Heart review.', NOW(), NOW()),
(1, 1, 2, '2024-07-19 11:00:00', 'Consultation', 'scheduled', 'General consultation.', NOW(), NOW()),

-- Patient 2
(1, 2, 2, '2024-05-02 09:30:00', 'Medical Check', 'completed', 'Routine pediatric check.', NOW(), NOW()),
(1, 2, 3, '2024-05-16 10:30:00', 'Medical Check', 'completed', 'General health review.', NOW(), NOW()),
(1, 2, 4, '2024-05-30 11:30:00', 'Clinical Procedure', 'cancelled', 'No show.', NOW(), NOW()),
(1, 2, 1, '2024-06-21 09:30:00', 'Consultation', 'scheduled', 'Cardio follow-up.', NOW(), NOW()),
(1, 2, 2, '2024-07-06 10:30:00', 'Medical Check', 'scheduled', 'Vaccination.', NOW(), NOW()),
(1, 2, 3, '2024-07-20 11:30:00', 'Medical Check', 'scheduled', 'Annual check.', NOW(), NOW()),

-- Patient 3
(1, 3, 3, '2024-05-03 10:00:00', 'Medical Check', 'completed', 'Blood test.', NOW(), NOW()),
(1, 3, 4, '2024-05-17 11:00:00', 'Clinical Procedure', 'completed', 'Skin allergy.', NOW(), NOW()),
(1, 3, 1, '2024-05-31 12:00:00', 'Consultation', 'cancelled', 'Rescheduled.', NOW(), NOW()),
(1, 3, 2, '2024-06-22 10:00:00', 'Medical Check', 'scheduled', 'Growth check.', NOW(), NOW()),
(1, 3, 3, '2024-07-07 11:00:00', 'Medical Check', 'scheduled', 'Lab results.', NOW(), NOW()),
(1, 3, 4, '2024-07-21 12:00:00', 'Clinical Procedure', 'scheduled', 'Skin follow-up.', NOW(), NOW()),

-- Patient 4
(1, 4, 4, '2024-05-04 10:30:00', 'Clinical Procedure', 'completed', 'Mole removal.', NOW(), NOW()),
(1, 4, 1, '2024-05-18 11:30:00', 'Consultation', 'completed', 'ECG.', NOW(), NOW()),
(1, 4, 2, '2024-06-01 12:30:00', 'Medical Check', 'cancelled', 'Family emergency.', NOW(), NOW()),
(1, 4, 3, '2024-06-23 10:30:00', 'Medical Check', 'scheduled', 'Blood pressure check.', NOW(), NOW()),
(1, 4, 4, '2024-07-08 11:30:00', 'Clinical Procedure', 'scheduled', 'Acne treatment.', NOW(), NOW()),
(1, 4, 1, '2024-07-22 12:30:00', 'Consultation', 'scheduled', 'Heart review.', NOW(), NOW()),

-- Patient 5
(1, 5, 1, '2024-05-05 11:00:00', 'Consultation', 'completed', 'Heart murmur review.', NOW(), NOW()),
(1, 5, 2, '2024-05-19 12:00:00', 'Medical Check', 'completed', 'Childhood illness.', NOW(), NOW()),
(1, 5, 3, '2024-06-02 13:00:00', 'Medical Check', 'cancelled', 'Patient sick.', NOW(), NOW()),
(1, 5, 4, '2024-06-24 11:00:00', 'Clinical Procedure', 'scheduled', 'Eczema check.', NOW(), NOW()),
(1, 5, 1, '2024-07-09 12:00:00', 'Consultation', 'scheduled', 'Routine ECG.', NOW(), NOW()),
(1, 5, 2, '2024-07-23 13:00:00', 'Medical Check', 'scheduled', 'Growth follow-up.', NOW(), NOW());
