...
const ServicesDrawer = ({ open, onClose }: ServicesDrawerProps) => {
  ...
  return (
    <>
      ...
      <Dialog open={deleteDialogOpen} onClose={handleDeleteCancel} aria-labelledby='delete-service-dialog-title'>
        <DialogTitle id='delete-service-dialog-title' sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <WarningAmberIcon color='error' sx={{ fontSize: 28 }} />
          {t('services.confirmation.delete.title')}
        </DialogTitle>
        <DialogContent>
          <Typography variant='subtitle1' color='error' sx={{ mb: 2 }}>
            {t('services.confirmation.delete.warning')}
          </Typography>
          <DialogContentText sx={{ mb: 2 }}>
            {t('services.confirmation.delete.message')
              .split('{name}')
          ...
          <DialogContentText color='text.secondary'>{t('services.confirmation.delete.description')}</DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleDeleteCancel} color='primary'>
            {t('services.confirmation.delete.cancel')}
          </Button>
          <Button onClick={handleDeleteConfirm} color='error' variant='contained' autoFocus disabled={isSubmitting}>
            {t('services.confirmation.delete.confirm')}
          </Button>
        </DialogActions>
      </Dialog>
    </>
